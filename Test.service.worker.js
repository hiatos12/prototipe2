...
/** @type {string} */
const CACHE_VERSION = '1789634921|2444699025';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["Test.html","Test.js","Test.offline.html","Test.icon.png","Test.apple-touch-icon.png","Test.audio.worklet.js","Test.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Test.wasm","Test.pck"];
